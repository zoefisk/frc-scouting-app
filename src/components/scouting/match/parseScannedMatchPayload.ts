...
export function parseScannedMatchPayload(
    ...
    const finalComments =
        typeof parsedData.finalComments === "object" && parsedData.finalComments !== null
    ...
    return {
        ...
        scoutingPosition: (setup.scoutingPosition ?? "") as MatchScoutingPayload["scoutingPosition"],
        ...
        robotPosition: (setup.robotPosition ?? null) as MatchScoutingPayload["robotPosition"],
        teamPresence: (setup.teamPresence ?? null) as MatchScoutingPayload["teamPresence"],

        autoData: {
            mobility: (autonomous?.mobility ?? null) as MatchScoutingPayload["autoData"]["mobility"],
            gamePieceOutcome: (autonomous?.gamePieceOutcome ?? null) as MatchScoutingPayload["autoData"]["gamePieceOutcome"],
            climb: (autonomous?.climb ?? null) as MatchScoutingPayload["autoData"]["climb"],
            alliancePointShare:
            ...
            driverControl:
                typeof teleop?.driverControl === "number"
                    ...
                    : teleop?.driverControl != null
                        ...
                        : 0,
            playedDefense:
                typeof teleop?.playedDefense === "boolean" ? teleop.playedDefense : null,
            defenseAbility:
            ...
            defenseResistance:
                typeof teleop?.defenseResistance === "number"
                    ...
                    : teleop?.defenseResistance != null
                        ...
                        : null,
            climb: (teleop?.climb ?? null) as MatchScoutingPayload["teleopData"]["climb"],
