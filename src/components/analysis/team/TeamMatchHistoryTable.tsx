...
import { TeamEventMatchRow } from "@/lib/tba/getTeamEventMatches";
                        ...
                        <TableBody>
                            {matches.map((match) => (
                                <TableRow key={match.matchKey} hover>
                                    ...
                                    <TableCell>{renderTeamChips(match.blueTeams, teamNumber)}</TableCell>
                                    <TableCell>{renderTeamChips(match.redTeams, teamNumber)}</TableCell>
                                    <TableCell>
                                        {match.videoUrl ? (
