    ...
    return (
        <Stack spacing={2}>
            ...
            <Typography color="text.secondary">
                Event is currently set to <strong>{eventKey}</strong>. Choose a match and
                scouting position. If lookup works, the team will be filled
