...
type Props = {
    ...
    onChange: (value: ScoutingPosition) => void;
};
        ...
        <FormControl fullWidth>
            <FieldLabelWithHelp
                ...
                tooltip={
                    <Box sx={{ p: 0.5 }}>
                        ...
                        <Typography variant="body2">Positions follow driver station order.</Typography>
                        <Typography variant="body2">• Blue 1–3 = left → right</Typography>
                        <Typography variant="body2">• Red 1–3 = left → right</Typography>
                        <Typography variant="body2" sx={{ mt: 1 }}>
                            Stand facing the field and match your assigned robot to its driver station slot.
                        </Typography>
                    </Box>
                }
            />
            ...
            <Select
                ...
                onChange={(event: SelectChangeEvent) =>
                    onChange(event.target.value as ScoutingPosition)
                }
                displayEmpty
                renderValue={(selected) => {
                    if (!selected) {
                        return <Typography color="text.secondary">Select position</Typography>;
                    }
