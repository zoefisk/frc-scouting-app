...
export default function OfflineEventsManager() {
    ...
    const [downloadedEvents, setDownloadedEvents] = React.useState<OfflineEventRecord[]>([]);
    ...
    return (
        <Stack spacing={3}>
            ...
            {!effectiveOnline && (
                <Alert severity="info">
                    Offline mode is active. Only previously downloaded events are available.
                </Alert>
            )}
                            ...
                            <React.Fragment key={event.eventKey}>
                                ...
                                >
                                    <Stack spacing={0.5}>
                                        ...
                                        <Typography variant="body2" color="text.secondary">
                                            Last updated: {new Date(event.lastUpdatedAt).toLocaleString()}
                                        </Typography>
                                    </Stack>
